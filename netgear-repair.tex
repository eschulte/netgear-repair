...
% FIXME Wes: Can you confirm?  Another way to state this is that
%            regular genprog will never mutate program data (e.g., a
%            struct) and thus can not perform repair which requires
%            such alterations.
