...
\label{sec-1}
 ...
 % A paragraph on router bugs and patching
...
%For example, Microsoft waits
%until the second Tuesday of every month (known as ``Patch Tuesday'')
%to release security patches \cite{lemos2003microsoft}, leading
%malicious users to release new exploits on the second Wednesday of
%every month (known as ``Exploit Wednesday'') to maximize the time
...
% protect themselves? 
% SF deleted this text, both for brevity and to shift focuse away from
% Soft. Eng.
...
%applications without waiting for software vendors to respond, 
...
%FIXME-ERIC: If we are tight for space, I think we can delete the rest
%of this paragraph. 
...
% landscape.  
% SF: This audience will not be interested in fitness valleys and such.
%This algorithmic choice acknowledges the fitness of the
...
\label{runtime}
%FIXME-ERIC: SF deleted most of this paragraph.
...
% (Figure \ref{ts-cov-rt-w-min}) varies with the size of the regression
...
% Test suite coverage and runtime with locations of minimized
...
%     the runtime of the suite in seconds.  

%After minimization, the modified locations do not
%    correlate with locations executed during test suite
%    executions. 
...
%FIXED-ERIC: How did you determine that it was satisfactory?
...
real-world software.
%FIXME-ERIC: Maybe a sentence or two here indicating how this worked.
%You ran the GA once, fixed one exploit, then had to run it again to
%fix the second.  They, you tested that the second repair did not
%invalidate the first repair.  Or something like that.

%FIXME-ERIC: need a citation to iterative repair, probably one of our
%earlier papers that discusses it in future work.
%
% FIXME-STEPH: I couldn't find any mention of this in the future work of the
...
%built programming languages, it has previously 
%been applied 
...
%\subsection{Automated Repair of Binary Code}
...
%In evaluation, this system successfully
%thwarted 7 of 10 attacks by a hostile red team.

\section{Discussion}
\label{sec:discussion}

% FIXED-ERIC: (below) We need more here.  I'd suggest putting a
% paragraph here about trend towards software-defined networks and
% what that might mean for router bugs and our ability to fix them.
...
%FIXME-ERIC: Add one sentence about how confident you are that your
%repair would work running natively, but don't lie.  Send it to me as
%a separate email if you want me to double check what you say.
...
%FIXME-ERIC: I think this paragraph can be deleted if you need to save
%space and are desperate.
...
locally;
%Without his help this work would not have been possible.  We
